...
\item 
\#define {\bfseries dict\-\_\-wordstr}(d, w)~((w) $<$ 0 ? {\bf \-N\-U\-L\-L} \-: (d)-\/$>$word[w].word)\label{dict_8h_a960244692f448457dbea9498108fe2d9}
...
s3wid\-\_\-t {\bf dict\-\_\-add\-\_\-word} ({\bf dict\-\_\-t} $\ast$d, char const $\ast$word, {\bf s3cipid\-\_\-t} const $\ast$p, {\bf int32} np)
...
const char $\ast$ {\bf dict\-\_\-ciphone\-\_\-str} ({\bf dict\-\_\-t} $\ast$d, s3wid\-\_\-t wid, {\bf int32} pos)
...
{\bf int32} {\bf dict\-\_\-word2basestr} (char $\ast$word)
...
\subsubsection[{dict\-\_\-num\-\_\-real\-\_\-words}]{\setlength{\rightskip}{0pt plus 5cm}\#define {\bf dict\-\_\-num\-\_\-real\-\_\-words}(
...
\subsubsection[{dict\-\_\-add\-\_\-word}]{\setlength{\rightskip}{0pt plus 5cm}s3wid\-\_\-t {\bf dict\-\_\-add\-\_\-word} (
\begin{DoxyParamCaption}
...
\-References dictword\-\_\-t\-::alt, \-B\-A\-D\-\_\-\-S3\-W\-I\-D, dictword\-\_\-t\-::basewid, dictword\-\_\-t\-::ciphone, ckd\-\_\-free(), ckd\-\_\-malloc, ckd\-\_\-realloc, ckd\-\_\-salloc, \-E\-\_\-\-E\-R\-R\-O\-R, \-E\-\_\-\-I\-N\-F\-O, hash\-\_\-table\-\_\-enter\-\_\-int32, hash\-\_\-table\-\_\-lookup\-\_\-int32(), dict\-\_\-t\-::ht, dict\-\_\-t\-::max\-\_\-words, dict\-\_\-t\-::n\-\_\-word, \-N\-U\-L\-L, dictword\-\_\-t\-::pronlen, dictword\-\_\-t\-::word, and dict\-\_\-t\-::word.
...
\subsubsection[{dict\-\_\-ciphone\-\_\-str}]{\setlength{\rightskip}{0pt plus 5cm}const char$\ast$ {\bf dict\-\_\-ciphone\-\_\-str} (
\begin{DoxyParamCaption}
\item[{{\bf dict\-\_\-t} $\ast$}]{d, }
\item[{s3wid\-\_\-t}]{wid, }
\item[{{\bf int32}}]{pos}
...
\-References dictword\-\_\-t\-::ciphone, dict\-\_\-t\-::mdef, \-N\-U\-L\-L, and dict\-\_\-t\-::word.
...
\subsubsection[{dict\-\_\-filler\-\_\-word}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf dict\-\_\-filler\-\_\-word} (
\begin{DoxyParamCaption}
\item[{{\bf dict\-\_\-t} $\ast$}]{d, }
\item[{s3wid\-\_\-t}]{w}
\end{DoxyParamCaption}
...
\subsubsection[{dict\-\_\-init}]{\setlength{\rightskip}{0pt plus 5cm}{\bf dict\-\_\-t}$\ast$ {\bf dict\-\_\-init} (
\begin{DoxyParamCaption}
...
\-References \-B\-A\-D\-\_\-\-S3\-W\-I\-D, lineiter\-\_\-t\-::buf, ckd\-\_\-calloc, ckd\-\_\-free(), cmd\-\_\-ln\-\_\-boolean\-\_\-r, cmd\-\_\-ln\-\_\-exists\-\_\-r(), cmd\-\_\-ln\-\_\-str\-\_\-r(), \-E\-\_\-\-E\-R\-R\-O\-R, \-E\-\_\-\-E\-R\-R\-O\-R\-\_\-\-S\-Y\-S\-T\-E\-M, \-E\-\_\-\-I\-N\-F\-O, dict\-\_\-t\-::filler\-\_\-end, dict\-\_\-t\-::filler\-\_\-start, dict\-\_\-t\-::finishwid, hash\-\_\-table\-\_\-new(), dict\-\_\-t\-::ht, lineiter\-\_\-next(), lineiter\-\_\-start(), dict\-\_\-t\-::max\-\_\-words, dict\-\_\-t\-::mdef, dict\-\_\-t\-::n\-\_\-word, \-N\-U\-L\-L, dict\-\_\-t\-::silwid, dict\-\_\-t\-::startwid, and dict\-\_\-t\-::word.

\index{dict.\-h@{dict.\-h}!dict\-\_\-real\-\_\-word@{dict\-\_\-real\-\_\-word}}
\index{dict\-\_\-real\-\_\-word@{dict\-\_\-real\-\_\-word}!dict.h@{dict.\-h}}
\subsubsection[{dict\-\_\-real\-\_\-word}]{\setlength{\rightskip}{0pt plus 5cm}\-P\-O\-C\-K\-E\-T\-S\-P\-H\-I\-N\-X\-\_\-\-E\-X\-P\-O\-R\-T int {\bf dict\-\_\-real\-\_\-word} (
\begin{DoxyParamCaption}
\item[{{\bf dict\-\_\-t} $\ast$}]{d, }
\item[{s3wid\-\_\-t}]{w}
\end{DoxyParamCaption}
...
\subsubsection[{dict\-\_\-report}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf dict\-\_\-report} (
\begin{DoxyParamCaption}
\item[{{\bf dict\-\_\-t} $\ast$}]{d}
\end{DoxyParamCaption}
...
\subsubsection[{dict\-\_\-word2basestr}]{\setlength{\rightskip}{0pt plus 5cm}{\bf int32} {\bf dict\-\_\-word2basestr} (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{word}
\end{DoxyParamCaption}
...
\subsubsection[{dict\-\_\-wordid}]{\setlength{\rightskip}{0pt plus 5cm}\-P\-O\-C\-K\-E\-T\-S\-P\-H\-I\-N\-X\-\_\-\-E\-X\-P\-O\-R\-T s3wid\-\_\-t {\bf dict\-\_\-wordid} (
\begin{DoxyParamCaption}
\item[{{\bf dict\-\_\-t} $\ast$}]{d, }
