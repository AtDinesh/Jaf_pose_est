...
5-\/state left-\/to-\/right \-H\-M\-Ms\-: (0 is the $\ast$emitting$\ast$ entry state and \-E is a non-\/emitting exit state; the x's indicate allowed transitions between source and destination states)\-:
...
\subsubsection[{hmm\-\_\-context}]{\setlength{\rightskip}{0pt plus 5cm}\#define {\bf hmm\-\_\-context}(
...
(hmm_mpx_ssid(h,st) == BAD_SENID \
                             ? BAD_SENID : (h)->ctx->sseq[hmm_mpx_ssid(h,st)][
      st])
\end{DoxyCode}
...
\subsubsection[{\-S\-E\-N\-S\-C\-R\-\_\-\-S\-H\-I\-F\-T}]{\setlength{\rightskip}{0pt plus 5cm}\#define {\bf \-S\-E\-N\-S\-C\-R\-\_\-\-S\-H\-I\-F\-T}~10}\label{hmm_8h_af94da16e3e5b550b9be05b0f07402cc7}
...
\-Referenced by gauden\-\_\-dist(), ps\-\_\-astar\-\_\-start(), ps\-\_\-latlink\-\_\-prob(), ps\-\_\-lattice\-\_\-bestpath(), ps\-\_\-lattice\-\_\-posterior(), ps\-\_\-lattice\-\_\-write(), ps\-\_\-lattice\-\_\-write\-\_\-htk(), senone\-\_\-eval(), senone\-\_\-init(), and tmat\-\_\-init().
...
\subsubsection[{\-W\-O\-R\-S\-T\-\_\-\-S\-C\-O\-R\-E}]{\setlength{\rightskip}{0pt plus 5cm}\#define {\bf \-W\-O\-R\-S\-T\-\_\-\-S\-C\-O\-R\-E}~((int)0x\-E0000000)}\label{hmm_8h_a833f100ee293ad0f1c03f2a5ef9be77a}
...
\subsubsection[{frame\-\_\-idx\-\_\-t}]{\setlength{\rightskip}{0pt plus 5cm}typedef {\bf int16} {\bf frame\-\_\-idx\-\_\-t}}\label{hmm_8h_a95afbcf23bff46debfe50cd7190e5bb8}
...
\subsubsection[{hmm\-\_\-clear}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf hmm\-\_\-clear} (
\begin{DoxyParamCaption}
...
\subsubsection[{hmm\-\_\-context\-\_\-free}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf hmm\-\_\-context\-\_\-free} (
\begin{DoxyParamCaption}
...
\subsubsection[{hmm\-\_\-dump}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf hmm\-\_\-dump} (
\begin{DoxyParamCaption}
\item[{{\bf hmm\-\_\-t} $\ast$}]{h, }
\item[{\-F\-I\-L\-E $\ast$}]{fp}
\end{DoxyParamCaption}
...
\subsubsection[{hmm\-\_\-dump\-\_\-vit\-\_\-eval}]{\setlength{\rightskip}{0pt plus 5cm}{\bf int32} {\bf hmm\-\_\-dump\-\_\-vit\-\_\-eval} (
\begin{DoxyParamCaption}
...
\subsubsection[{hmm\-\_\-vit\-\_\-eval}]{\setlength{\rightskip}{0pt plus 5cm}{\bf int32} {\bf hmm\-\_\-vit\-\_\-eval} (
\begin{DoxyParamCaption}
\item[{{\bf hmm\-\_\-t} $\ast$}]{hmm}
\end{DoxyParamCaption}
