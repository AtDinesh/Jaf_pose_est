...
\subsubsection[{yin\-\_\-read}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf yin\-\_\-read} (
...
\subsubsection[{yin\-\_\-write}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf yin\-\_\-write} (
\begin{DoxyParamCaption}
\item[{{\bf yin\-\_\-t} $\ast$}]{pe, }
