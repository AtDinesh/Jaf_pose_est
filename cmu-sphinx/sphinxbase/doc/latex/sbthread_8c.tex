...
\subsubsection[{sbmsgq\-\_\-init}]{\setlength{\rightskip}{0pt plus 5cm}{\bf sbmsgq\-\_\-t}$\ast$ {\bf sbmsgq\-\_\-init} (
...
\subsubsection[{sbthread\-\_\-send}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf sbthread\-\_\-send} (
\begin{DoxyParamCaption}
