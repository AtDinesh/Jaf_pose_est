...
\subsubsection[{yin\-\_\-read}]{\setlength{\rightskip}{0pt plus 5cm}\-S\-P\-H\-I\-N\-X\-B\-A\-S\-E\-\_\-\-E\-X\-P\-O\-R\-T int {\bf yin\-\_\-read} (
...
\hline
{\em out\-\_\-period} & \-Output\-: an estimate of the period ($\ast$not$\ast$ the pitch) of the signal in samples. \\
\hline
...
\subsubsection[{yin\-\_\-write}]{\setlength{\rightskip}{0pt plus 5cm}\-S\-P\-H\-I\-N\-X\-B\-A\-S\-E\-\_\-\-E\-X\-P\-O\-R\-T void {\bf yin\-\_\-write} (
\begin{DoxyParamCaption}
\item[{{\bf yin\-\_\-t} $\ast$}]{pe, }
